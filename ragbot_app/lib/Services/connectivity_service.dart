...
class ConnectivityService {
  ...
  final StreamController<InternetStatus> _controller = StreamController.broadcast();
  ...
  Future<InternetStatus> getConnectionState() async{
    return await InternetConnection().hasInternetAccess ? InternetStatus.connected : InternetStatus.disconnected;
  }
