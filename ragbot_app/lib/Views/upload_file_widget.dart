...
import 'package:ragbot_app/Views/no_server_widget.dart';
...
class _UploadFileWidgetState extends State<UploadFileWidget> {
  ...
  Widget build(BuildContext context) {
    return Consumer<UploaderViewController>(
        builder: (context, uploaderViewController, child) {
      if (!uploaderViewController.serverRunning) {
        return const NoServerConnectionWidget();
      } else {
        return Flex(
              ...
              child: SizedBox(
                ...
                child: FittedBox(
                  child: ElevatedButton.icon(
                    ...
                    onPressed:
                        widget.uploaderViewController.isButtonEnabled == true
